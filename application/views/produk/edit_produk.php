...
<!-- 
                    ...
                    <div class="form-group">
                      <label for="">Bahan</label>
                        <input type="text" class="form-control" value="<?php echo $bahan; ?>" id="" name="bahan" placeholder="Nama Bahan" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Link (https://linkmu.com)</label>
                        <input type="text" class="form-control" value="<?php echo $jumlah; ?>" id="" name="jumlah" placeholder="linkmu" required>                        
                    </div>
