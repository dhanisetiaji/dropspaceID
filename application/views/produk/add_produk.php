                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">Bahan</label>
                        <input type="text" class="form-control" value="" id="" name="bahan" placeholder="NAMA BAHAN" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Link (https://linkmu.com)</label>
                        <input type="text" class="form-control" value="" id="" name="jumlah" placeholder="linkmu gan" required>                        
                    </div>
