          ...
          <section class="col-lg-6">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM TAMBAH/EDIT MODEL</h3>
              </div>
                ...
                <div class="item">
                  <form action="<?php echo base_url(); ?>merk/savedata" method="post">
                    <div class="form-group">
                      <label for="namalengkap">Nama Model</label>
                        <input type="text" class="form-control" value="<?php echo $merk; ?>" id="" name="merk" placeholder="Isikan model" required>
                    </div>
